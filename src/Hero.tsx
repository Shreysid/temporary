...
const Hero = () => {
  return (
    <div className="w-full m-auto flex flex-col md:flex-row lg:flex-row h-[80vh] px-12 md:px-8 lg:px-4">
      <div className="flex flex-col md:w-1/2 justify-center text-center items-center md:items-start md:text-left lg:text-left">
        ...
        <h2 className="text-gray pt-2 md:pt-4 text-xl md:text-2xl">
          Selling online is as simple as sharing content.
        </h2>
        <button className="px-6 py-2 bg-orange w-36 my-2 md:my-4 text-white rounded-full">
          Explore
        </button>

        {/* Reviews */}
        <div className="flex flex-col my-2 md:flex-row">
          <div className="flex my-2 md:my-0 translate-x-4 md:translate-x-0">
          ...
          <div className="flex flex-col items-start md:-translate-x-4 mb-4">
